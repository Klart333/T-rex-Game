...
public class Items : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (timer >= 0.1f || num == 0)
        {
            ...
            {
                if (amountOfSaft >= 1 && itemSlot1Image.sprite != saft && itemSlot2Image.sprite != saft && itemSlot3Image.sprite != saft)
                {

                    itemSlot1Image.sprite = saft;
                }
                else if (amountOfValnut >= 1 && itemSlot1Image.sprite != valnut && itemSlot2Image.sprite != valnut && itemSlot3Image.sprite != valnut)
                {
                    itemSlot1Image.sprite = valnut;
                }
                else if (amountOfRolex >= 1 && itemSlot1Image.sprite != rolex && itemSlot2Image.sprite != rolex && itemSlot3Image.sprite != rolex)
                {
